...
export async function fetchBuienradar(dateParsed, databaseData, resolve, times) {
  ...
  // rawData = JSON.parse(readFileSync("projectFiles/test files DST/from CET to CEST/Buienradar.json"))
